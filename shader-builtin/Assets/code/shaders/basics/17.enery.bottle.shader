	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half smoothstepResult32 = smoothstep( step( (-1.5 + (texCoord31.y - 0.0) * (2.5 - -1.5) / (1.0 - 0.0)) , ( (-2.0 + (_Value - 0.0) * (2.0 - -2.0) / (1.0 - 0.0)) + gradientNoise25 ) ) , step( (-1.5 + (texCoord10.y - 0.0) * (2.5 - -1.5) / (1.0 - 0.0)) , ( (-2.0 + (_Value - 0.0) * (2.0 - -2.0) / (1.0 - 0.0)) + gradientNoise14 ) ) , 0.5);
...
/*ASEBEGIN
Version=18935
-254;-1035;1920;1014;2571.559;1539.849;1.456186;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-588.2349,148.8893;Inherit;False;Property;_FresnelPower;FresnelPower;3;0;Create;True;0;0;0;False;0;False;5;3.54;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;35;-358.2349,271.8893;Inherit;False;Property;_FresnelColor;FresnelColor;2;1;[HDR];Create;True;0;0;0;False;0;False;0.7924528,0.5142992,0.03364185,0;0.1214263,5.148474,0.5497323,0.4980392;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;38;-186.2349,-391.1107;Inherit;False;Property;_EnergyColor;EnergyColor;1;1;[HDR];Create;True;0;0;0;False;0;False;0.5257774,1,0.0235849,0;1,0.2156863,0.007843138,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=892208BDDE6C4DC89BE39EFE5F9DE46BAE77347E